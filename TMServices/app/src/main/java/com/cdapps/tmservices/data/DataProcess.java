...
import com.cdapps.tmservices.search.SearchCounts;
import com.cdapps.tmservices.search.SearchResults;
...
//                    }
    ...
    public MemberInfo ProcessMemberInfo(JSONObject data) throws  JSONException {
        String firstName = data.optString("FirstName");
        String occupation = data.optString("Occupation");
        String biography = data.optString("Biography");
        String quote = data.optString("Quote");
        Member member = ProcessMember(data.getJSONObject("Member"));

        MemberInfo memberInfo = new MemberInfo(firstName, occupation, biography, quote, member);
